...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="contained" color="success" onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="medium" /></Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button variant="contained" color="warning" onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="medium" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions>
            <Button size="large" variant="contained" color="secondary" onClick={handleOpen}>Criar Tarefa</Button>
